...
class EssaysControllerTest < ActionController::TestCase
  ...
  test "should create essay" do
    assert_difference('Essay.count') do
      post :create, essay: { revier_one: @essay.revier_one, reviewer_two: @essay.reviewer_two, student_name: @essay.student_name, text: @essay.text }
    end
  ...
  test "should update essay" do
    patch :update, id: @essay, essay: { revier_one: @essay.revier_one, reviewer_two: @essay.reviewer_two, student_name: @essay.student_name, text: @essay.text }
    assert_redirected_to essay_path(assigns(:essay))
  end
